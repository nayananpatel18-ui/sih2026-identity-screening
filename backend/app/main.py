...
from app.api.routes import fraud_resilience, health, samples, upload, screenings
...
app.include_router(fraud_resilience.router, prefix=settings.API_V1_STR, tags=["Fraud Resilience Lab"])
